...
- [`docs/functional-skill-architecture.md`](docs/functional-skill-architecture.md) — functional-programming approach for composing skills like pure functions, tracing inputs/outputs, and keeping the catalog portable across IDE and cloud agents.
